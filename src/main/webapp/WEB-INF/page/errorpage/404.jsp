...
<c:import charEncoding="utf-8"  url="/member/layout/common_top.htm">
    <c:param name="title" value="404错误"/>
    ...
    <section class="content">
        <div class="error-page">
            ...
            <div class="error-content">
                <h3><i class="fa fa-warning text-yellow"></i> 当前请求的路径未找到</h3>

                <p>
                    很抱歉,我们无法在系统内找到您要访问的路径,如有疑问,请联系系统管理员解决,您也可以点此<a href="javascript:history.back(0)">返回上一页</a>,
